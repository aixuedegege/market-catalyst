...
<body>
    <div class="topbar">
        <span class="topbar-stats">
            <a href="https://github.com/aixuedegege/market-catalyst" target="_blank" class="topbar-link" title="View Source on GitHub">GitHub</a>
...
.topbar-link { color: var(--text-secondary); text-decoration: none; font-size: 0.8rem; margin-right: 12px; display: flex; align-items: center; gap: 4px; }
